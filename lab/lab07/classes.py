...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        The attack and defense of p2's card have been swapped!
        >>> other_card.attack
        600
        >>> other_card.defense
        300
        ...
        #Uncomment the line below when you've finished implementing this method!
        print('The attack and defense of {}\'s card have been swapped!'.format(opponent.name))
